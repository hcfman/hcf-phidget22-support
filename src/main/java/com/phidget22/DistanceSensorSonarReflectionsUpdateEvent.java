...
public class DistanceSensorSonarReflectionsUpdateEvent {
	...
	int[] Amplitudes;
	int Count;
	public DistanceSensorSonarReflectionsUpdateEvent(DistanceSensor Source, int[] distances, int[] amplitudes, int count) {
		this.Source = Source;
	...
	public String toString() {
		return "[DistanceSensorSonarReflectionsUpdateEvent](" +
			"Source: " + Source + ", " +
