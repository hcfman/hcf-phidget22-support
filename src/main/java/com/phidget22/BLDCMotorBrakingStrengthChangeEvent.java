...
public class BLDCMotorBrakingStrengthChangeEvent {
	...
	public BLDCMotorBrakingStrengthChangeEvent(BLDCMotor Source, double brakingStrength) {
		this.Source = Source;
	...
	public String toString() {
		return "[BLDCMotorBrakingStrengthChangeEvent](" +
			"Source: " + Source + ", " +
			"BrakingStrength: " + BrakingStrength +
			")";
	}
}
